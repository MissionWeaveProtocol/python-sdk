...
対して、組み込みの 56 個すべてのベクトルを検証します。妥当性が期待値と一致しない場合は、
...
使い捨てのローカル鍵、Agent Card を含み Organization によって署名された Agent Registry、
および Agent Registry の署名鍵をすべて含む完全な snapshot を作成します。
