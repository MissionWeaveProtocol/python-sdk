...
Crea claves locales desechables, un Agent Registry firmado por la Organization que contiene
Agent Cards, y un snapshot completo de las claves de firma del Agent Registry:
