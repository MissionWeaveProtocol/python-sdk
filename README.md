...
The conformance command validates all 56 vendored vectors against the 21 vendored Draft 2020-12
...
Create disposable local keys, an Organization-signed Agent Registry containing Agent Cards, and a
complete Agent Registry signing-key snapshot:
