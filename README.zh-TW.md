...
- 對等 Conversation，以及顯式的 Work Proposal、工作項授權、Work Offer、接受 Work Offer、所有權、
...
- 遞迴的子任務（Child Mission）和相互關聯的後續 Mission；
...
包含由 Worker 透過正式 Work Proposal 提出的後代工作項、一個安全子任務、Worker 之間的
